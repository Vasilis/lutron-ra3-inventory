"""Embedded keys and certificates used during the pairing handshake.

Vendored verbatim from pylutron-caseta v0.28.0 (Apache-2.0):
https://github.com/gurumitts/pylutron-caseta/blob/v0.28.0/src/pylutron_caseta/assets.py

These are Lutron's well-known LAP (Lutron Access Protocol) bootstrap
credentials — they're public artifacts shipped inside every Caseta/RA 3
processor and the official Lutron mobile apps; the pairing handshake uses
them to mutually authenticate the client before the processor signs a
